        ...
        try {
            ...
            if (user.departmentID) {
                ...
                if (department?.managerID) {
                    const notification = await this.notificationService.createNotification(userID, department.managerID, `New leave application submitted by ${user.username} from ${startDate} to ${endDate} (${duration} days).`, client_1.NotificationRelatedType.LEAVE);
