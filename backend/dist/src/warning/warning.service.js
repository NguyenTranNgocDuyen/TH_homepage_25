...
let WarningService = class WarningService {
    ...
    async sendWarning(createWarningDto) {
        ...
        return await this.prismaService.$transaction(async (tx) => {
            ...
            const notification = await this.notificationService.createNotification('system', userID, `Bạn có cảnh báo mới: ${content}`, client_1.NotificationRelatedType.WARNING, tx);
